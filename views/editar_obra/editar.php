...
<body>
    ...
    <form action="../controllers/EditarController.php" method="POST">
        ...
        <select name="clasificacion_generica" id="clasificacion_generica">
            <option value="">Selecciona Clasificación</option>
            <?php foreach ($clasificacionesGenericas as $clasificacion): ?>
                <option value="<?= $clasificacion['texto_clasificacion'] ?>" <?= $obra['texto_clasificacion'] == $clasificacion['texto_clasificacion'] ? 'selected' : '' ?>>
        ...
        <select name="material" id="material">
            ...
            <?php foreach ($materiales as $material): ?>
                <option value="<?= $material['texto_material'] ?>" <?= $obra['texto_material'] == $material['texto_material'] ? 'selected' : '' ?>>
        ...
        <select name="tecnica" id="tecnica">
            ...
            <?php foreach ($tecnicas as $tecnica): ?>
                <option value="<?= $tecnica['texto_tecnica'] ?>" <?= $obra['texto_tecnica'] == $tecnica['texto_tecnica'] ? 'selected' : '' ?>>
        ...
        <select name="forma_ingreso" id="forma_ingreso">
            ...
            <?php foreach ($formasIngreso as $forma): ?>
                <option value="<?= $forma['texto_forma_ingreso'] ?>" <?= $obra['texto_forma_ingreso'] == $forma['texto_forma_ingreso'] ? 'selected' : '' ?>>
