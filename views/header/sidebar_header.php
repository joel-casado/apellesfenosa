<div class="sidebar">
    <ul class="menu">
        ...
        <li><a href="index.php?controller=usuaris&action=listar_usuarios"><i class="fas fa-user"></i> <span>Usuaris</span></a></li>
        <li><a href="index.php?controller=Backup&action=createBackup"><i class="fas fa-file"></i> <span>Backup</span></a></li>
