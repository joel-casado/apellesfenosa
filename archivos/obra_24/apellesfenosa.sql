...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 13-11-2024 a les 11:38:23
...
INSERT INTO `obras` (`numero_registro`, `classificacion_generica`, `nombre_objeto`, `coleccion_procedencia`, `maxima_altura`, `maxima_anchura`, `maxima_profundidad`, `material`, `tecnica`, `autor`, `titulo`, `ano_inicio`, `ano_final`, `datacion`, `ubicacion`, `fecha_registro`, `numero_ejemplares`, `forma_ingreso`, `fecha_ingreso`, `fuente_ingreso`, `baja`, `causa_baja`, `fecha_baja`, `persona_aut_baja`, `estado_conservacion`, `lugar_ejecucion`, `lugar_procedencia`, `num_tirada`, `otros_num_id`, `valoracion_econ`, `id_exposicion`, `bibliografia`, `descripcion`, `historia_obra`) VALUES
(1, 1, '', 'prueba1', 5.17, 2.12, 1.50, 10, 2, 3, 'prueba1', 1402, 1602, 4, 1, '2024-11-14', 1, 6, '2024-11-15', 'prueba1', NULL, NULL, NULL, NULL, NULL, 'prueba1', 'prueba1', NULL, NULL, 1002000.00, NULL, 'prueba1', 'prueba1', 'prueba1'),
(2, 1, '', 'Nuevo', 2.12, 2.12, 1.52, 3, 3, 1, 'Nuevo', 1400, 1600, 2, 1, '2024-10-03', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Excelente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nuevo', NULL),
(3, NULL, '', 'prueba', 5.17, 2.15, 1.50, 8, 3, 1, 'prueba', -225, -251, 2, 1, '2024-11-14', 1, 5, '0000-00-00', '2024-11-14', NULL, NULL, NULL, NULL, 'prueba', 'prueba', NULL, NULL, NULL, 0.00, NULL, '1002000.00', 'prueba', 'prueba'),
(4, 2, '', 'prueba4', 5.17, 2.15, 1.50, 8, 3, 1, 'prueba4', -225, -251, 2, 1, '2024-11-14', 1, 5, '0000-00-00', '2024-11-14', NULL, NULL, NULL, NULL, 'prueba4', 'prueba4', 'prueba4', NULL, NULL, 0.00, NULL, '1002000.00', 'prueba4', 'prueba4'),
(5, 1, '', 'prueba2', 5.17, 2.15, 1.50, 3, 2, 2, 'prueba2', 1402, 1602, 4, 1, '2024-11-08', 1, 4, '0000-00-00', '2024-11-14', NULL, NULL, NULL, NULL, 'prueba2', 'prueba2', NULL, NULL, NULL, 0.00, NULL, '1111111.00', 'prueba2', 'prueba2'),
(6, 1, '', 'pppp', 2.12, 2.12, 1.50, 4, 2, 2, 'pppp', -100, -176, NULL, NULL, '0000-00-00', 0, 16, '0000-00-00', '2024-11-06', NULL, NULL, NULL, NULL, 'pppp', NULL, 'pppp', NULL, NULL, 0.00, NULL, '1002200.00', '2024-11-15', 'pppp'),
(7, 1, 'aaaaaaa', 'aaaaaaa', 5.18, 2.12, 1.50, 122555, 3, 3, 'aaaaaaa', -75, -76, 18, NULL, '2024-11-20', 1, 4, '2024-11-11', 'aaaaaaa', NULL, NULL, NULL, NULL, NULL, 'aaaaaaa', 'aaaaaaa', NULL, NULL, 1002000.00, NULL, 'aaaaaaa', 'aaaaaaa', 'aaaaaaa'),
(9, 2, 'nombre', 'coleccion procedencia', 5.18, 2.15, 1.50, 10, 2, 4, 'titulo', -100, 100, 14, NULL, '2024-11-14', 1, 18, '2024-11-14', 'fuente ingreso', NULL, NULL, NULL, NULL, NULL, 'ejecucion', 'procedencia', NULL, NULL, 1002200.00, NULL, 'biblibografia', 'descripcion', 'historia'),
(10, 0, 'nombre', 'coleccion procedencia', 5.18, 2.15, 1.50, 9, 3, 3, 'titulo', 1, -1, 18, NULL, '2024-11-14', 1, 18, '2024-11-14', 'fuente ingreso', NULL, NULL, NULL, NULL, NULL, 'prueba', 'Florencia', NULL, NULL, 1002200.00, NULL, 'Bibliografía', 'Descripción', 'Historia de la Obra:'),
(11, 0, '', 'aaaa', NULL, NULL, NULL, NULL, NULL, 1, 'aa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 2, 'Creada', 'cambio', 5.18, 1.00, 1.00, 3, 1, 2, 'David2', 1501, 0, 2, 1, '0000-00-00', 1, 1, '2023-09-15', 'Donación privada\n', 0, NULL, NULL, NULL, 'Excelente', 'Florencia', 'Florencia', 1, '1234ABC', 1000000.00, 1, 'Bibliografía de David\n', 'a', 'Bibliografía de David\n'),
(13, 2, '', '1', 5.18, 1.00, 1.00, 3, 1, 2, 'Creada2', 1501, 0, 2, 1, '2024-10-03', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'aa', NULL),
(14, 0, 'nombre', 'coleccion procedencia', 5.18, 2.15, 1.50, 1, 1, 2, 'titulo', -375, -26, 17, NULL, '2024-11-14', 1, 15, '2024-11-29', 'fuente ingreso', NULL, NULL, NULL, NULL, '5', 'ejecucion', 'procedencia', NULL, NULL, 1002200.00, NULL, 'Bibliografía', 'Descripción', 'Historia');
...
INSERT INTO `prestamos` (`id_prestamo`, `numero_registro`, `fecha_prestacion`, `fecha_devolucion`, `activo`) VALUES
(1, 12, '2012-03-15', '2012-03-16', 1),
(2, 2, '0000-00-00', '0000-00-00', 1),
(12, 13, '2012-03-04', '2012-04-04', 0);
...
INSERT INTO `ubicaciones` (`id_ubicacion`, `fecha_inicio_ubi`, `fecha_fin_ubi`, `ubicacion_padre`, `comentario_ubicacion`, `nombre_ubicacion`) VALUES
(1, '2023-01-01', NULL, NULL, 'Sala principal', 'hola'),
(2, '2023-05-01', NULL, 1, 'Almacén de reserva', 'adios');
...
--
ALTER TABLE `archivos`
  ADD CONSTRAINT `fk_numero_registro` FOREIGN KEY (`numero_registro`) REFERENCES `obras` (`numero_registro`);

--
-- Restriccions per a la taula `obras`
--
ALTER TABLE `obras`
...
--
-- Restriccions per a la taula `prestamos`
--
ALTER TABLE `prestamos`
